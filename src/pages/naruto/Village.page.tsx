import CardVillage from "../../components/catalog/CardVillage.component";
...
export default function VillagePage() {
  ...
  const { currentItems, currentPage, setCurrentPage, totalPages } =
	usePagination(state.villages, 21);

  return (
	<main className="bg-[url(https://imgs.search.brave.com/nKhh__HbK4LVSqShZL7BVaCMo_E3vZYW7o8cdeVJeCo/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly93YWxs/cGFwZXJhY2Nlc3Mu/Y29tL2Z1bGwvNjMw/NTM3LnBuZw)] bg-white/50 bg-blend-overlay bg-contain">
