...
export const RegisterPage = () => {
  const registerFields = [
    {text: "Username:", inputName:"username", type: "text", placeHolder: "example"},
    ...
    {text: "Confirm Password:", inputName:"ConfirmPassword", type: "password", placeHolder: "********"},
  ];

  return (
    <main className="w-full max-w-sm mx-auto my-40 p-4 rounded-lg shadow-sm sm:p-6 md:p-8 bg-gray-800 border-gray-700">
      <FormAuth formFields={registerFields} formType="register" />
    </main>
  );
};
