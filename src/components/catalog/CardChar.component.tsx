...
export default function CardChar({ item }: Props) {
  const image =
    item.name === "Jiraiya"
      ? "https://imgs.search.brave.com/8tXFjj4WyQuoia0I9QWiAkKhDItbqFk3gwkjUmOw7g0/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9pLnBp/bmltZy5jb20vb3Jp/Z2luYWxzL2U5Lzk3/L2Y2L2U5OTdmNjY0/NjIyNmRiZTg3MWI1/ZmNmZjdhYjJhZDJm/LmpwZw"
      : item.name === "Kurama"
      ? "https://imgs.search.brave.com/sHqvAgCnL0qoa3iWKpgfvUVanpxFdkone2FDz-2boR8/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9wbTEu/YW1pbm9hcHBzLmNv/bS82NTg1L2NkYjM5/NDEzMjljZDdkMGVi/YTk0ODBhNWM5YjRi/N2JlNWM2ZDRhZGFf/aHEuanBn"
      : item.images[0];
